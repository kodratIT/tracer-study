...
<body>
    <div class="header">
        ...
        <div class="subtitle">Laporan BAN-PT - {{ ucfirst(str_replace('_', ' ', $report->report_type)) }}</div>
        <div class="subtitle">{{ $report->session->display_name ?? 'Semua Sesi' }}</div>
    </div>
    ...
    <div class="meta-info">
        ...
        <div class="meta-row">
            ...
            <span>{{ strtoupper($report->file_format) }}</span>
        </div>
        <div class="meta-row">
